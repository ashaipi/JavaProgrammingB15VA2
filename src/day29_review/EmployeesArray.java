...
public class EmployeesArray {
    public static void main(String[] args) {
        ...
        for(String e : employees)
            System.out.println(e.substring(e.indexOf("[")+1,e.indexOf("]")));

        // TASK 2. Print firstName-lastName jobTitle
        System.out.println("--------------------------------");

        for(String e : employees){
            System.out.print(e.substring(0,e.indexOf(" "))+"-");
            System.out.print(e.substring(e.indexOf(" ")+1,e.indexOf(" [")));
            System.out.println(e.substring(e.indexOf("[")+1,e.indexOf("]")));
        }
        System.out.println("--------------------------------");
        for(String e : employees){
            String[] empArray = e.split(" ");
            System.out.print(empArray[0]+"-"+empArray[1]+" ");
            System.out.println(e.substring(e.indexOf("[")+1,e.indexOf("]")));
        }
        // look for 2 people in the array and assert below data
        // Tracy Bartle [Geological Engineer]
        // Skipper Abrahamsson [Financial Advisor]
        for(String e : employees){
            String[] empArray = e.split(" ");
            String job = e.substring(e.indexOf("[")+1,e.indexOf("]"));

            if(empArray[0].equals("Tracy") && empArray[1].equals("Bartle"))
                if(job.equals("Geological Engineer")) System.out.println("Pass");
                else System.out.println("Fail");
            if(empArray[0].equals("Skipper") && empArray[1].equals("Abrahamsson"))
                if(job.equals("Financial Advisor")) System.out.println("Pass");
                else System.out.println("Fail");
        }
